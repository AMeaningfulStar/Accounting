...
export default function TableBox({ headerNames }: TableBoxType) {
    ...
    <TableContainer component={Paper}>
      <Table sx={{ width: "100%" }} aria-label="custom pagination table">
        <TableHead className="bg-gray-300">
          <TableRow>
            {headerNames && headerNames.map((name, idx) => (
              <TableCell key={idx} align="center" className="font-semibold text-sm">
                {name}
              </TableCell>
            ))}
          </TableRow>
